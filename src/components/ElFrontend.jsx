...
export default function ElFrontend() {
  ...
  async function handleUrlSubmit(e) {
    ...
    console.log("⬆️ Payload verstuurd naar backend:", payload);
    alert(`Verstuur: ${JSON.stringify(payload)}`);
  ...
  function getStatusText() {
    switch (status) {
      ...
      case 'speaking': return '🔊 Ruth spreekt...';
  ...
  return (
    <div style={{ display: 'flex', flexDirection: 'column', alignItems: 'center', padding: '2rem', fontFamily: 'sans-serif' }}>
      <h2 style={{ fontSize: '1.5rem', marginBottom: '1rem' }}>Spreek met Ruth</h2>
